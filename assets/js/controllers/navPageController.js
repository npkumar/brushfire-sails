angular.module('brushfire').controller('navPageController', [
  '$location',
  '$scope',
  '$http',
  'toastr',
    ...
    $scope.submitLoginForm = function() {
      ...
      $http.put('/login', {
        ...
        if (sailsResponse.status == 403) {
          toastr.error(sailsResponse.data, 'Error', {closeButton: true});
          return;
        }
        ...
        if (sailsResponse.status === 400 || 404) {
          ...
          //
          toastr.error('Invalid email or username/password combination.', 'Error', {closeButton: true});
          return;
        }
